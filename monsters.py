...
ICON_DIR = os.path.join(os.path.dirname(__file__),'pig')

ANIMATION_MONSTERHORYSONTAL = [(image.load(os.path.join(ICON_DIR, 'fire1.png'))),
                               (image.load(os.path.join(ICON_DIR, 'fire2.png')))]
